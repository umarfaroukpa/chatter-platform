...
const Personalize = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen pt-8 px-4 md:px-8">
            <h1 className="text-4xl md:text-4xl text-center font-bold  md:text-left">Select All That Applies To You</h1>
            ...
            <div className="flex flex-col items-center md:items-start justify-start space-y-4 md:space-y-8 max-w-3xl">
                ...
                <div className="flex justify-center  mb-8 md:mb-12">
                    <button
                        ...
                        className={`relative flex items-center justify-between py-4 md:py-6 px-8 md:px-8 border-2 rounded-2xl w-full md:w-72 h-20 md:h-28 transform transition-transform duration-300 ease-in-out hover:scale-105 
                            focus:outline-none focus:ring-4 focus:ring-blue-300 focus:border-[#07327a]
