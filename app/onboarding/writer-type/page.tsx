...
const ProgressBar = ({ currentStep }: { currentStep: number }) => {
    ...
    return (
        <div className="flex flex-col items-center justify-start md:items-center pt-16 md:justify-center min-h-screen md:-mt-32 px-4">
            <div className="flex flex-col items-center w-full max-w-4xl md:mt-16">
