                ...
                <div className="flex flex-col items-start justify-start ">
                    ...
                    <div className="flex space-x-8 mb-12 ">
                        ...
                        <div
                            ...
                            className={`cursor-pointer rounded-lg p-4 w-60 flex items-center space-x-4 bg-gray-100 transform transition-transform duration-300 ease-in-out hover:scale-105 
                            ...
                            tabIndex={0}
                        >
                            <Pencil size={50} className="text-[#787474] rounded-lg" />
                            <div>
                        ...
                        <div
                            ...
                            className={`cursor-pointer  rounded-lg p-4 w-60 flex items-center space-x-4 bg-slate-100 transform transition-transform duration-300 ease-in-out hover:scale-105 
                                focus:outline-none focus:ring-4 focus:ring-blue-300 focus:border-[#07327a]
                                ${role === "Writer"
                                    ? "border-[#07327a] shadow-lg rounded-2xl"
                                    : " rounded-lg"
