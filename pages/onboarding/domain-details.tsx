...
const DomainDetails = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-start md:justify-center min-h-screen mt-10 md:mt-0 px-4">
            <div className="text-left w-full max-w-4xl mt-10">
